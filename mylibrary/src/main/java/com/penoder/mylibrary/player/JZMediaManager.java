package com.penoder.mylibrary.player;
...
public class JZMediaManager implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private static com.penoder.mylibrary.player.JZMediaManager JZMediaManager;
    ...
    public static com.penoder.mylibrary.player.JZMediaManager instance() {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        mediaPlayer.setOnPreparedListener(com.penoder.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnCompletionListener(com.penoder.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnBufferingUpdateListener(com.penoder.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setScreenOnWhilePlaying(true);
                        mediaPlayer.setOnSeekCompleteListener(com.penoder.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnErrorListener(com.penoder.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnInfoListener(com.penoder.mylibrary.player.JZMediaManager.this);
                        mediaPlayer.setOnVideoSizeChangedListener(com.penoder.mylibrary.player.JZMediaManager.this);
